...
class TestCellEvaluatorMovement:
    """Tests for evaluate_movement_destination."""
    ...
    def test_movement_closer_to_enemy_scores_higher(
        ...
        # Act
        score_near = evaluator.evaluate_movement_destination(near, board_evaluation)
        score_far = evaluator.evaluate_movement_destination(far, board_evaluation)
    ...
    def test_movement_equidistant_scores_equal_when_safe(
        ...
        # Act
        score_a = evaluator.evaluate_movement_destination(pos_a, board_evaluation)
        score_b = evaluator.evaluate_movement_destination(pos_b, board_evaluation)
    ...
    def test_movement_defensive_when_threatened(
        ...
        # Act
        score_near = evaluator.evaluate_movement_destination(near_own, board_evaluation)
        score_far = evaluator.evaluate_movement_destination(far_own, board_evaluation)
    ...
    def test_movement_score_is_deterministic(
        ...
        # Act
        score1 = evaluator.evaluate_movement_destination(coords, board_evaluation)
        score2 = evaluator.evaluate_movement_destination(coords, board_evaluation)
    ...
    def test_movement_exact_score_at_enemy_master(
        ...
        # Act
        score = evaluator.evaluate_movement_destination(pos, board_evaluation)
